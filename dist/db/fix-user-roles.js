...
async function fixUserRoles() {
    try {
        ...
        await db.execute(sql `UPDATE users SET role = 'Nurse' WHERE role IS NULL OR role = 'undefined'`);
        ...
        await db.execute(sql `UPDATE users SET role = 'Nurse' WHERE role IS NULL`);
        // Verify the update
